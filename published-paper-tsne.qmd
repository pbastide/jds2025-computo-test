...
source(file = "scripts/plotutils.R")
plot_dataset("compute/mnist6000", methods = c("tsne"))[[1]]
plot_dataset("compute/mnist6000", methods = c("sammon"))[[1]]
plot_dataset("compute/mnist6000", methods = c("isomap"))[[1]]
plot_dataset("compute/mnist6000", methods = c("lle"))[[1]]
```
